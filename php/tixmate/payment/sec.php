...
$sel="select * from user where id = '$_REQUEST[uid]'";
$row=mysqli_query($con,$sel);
$data=mysqli_fetch_array($row);

$cname=$data["name"];
$cemail=$data["email"];
$ccontact=$data["phone_no"];
                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style28">
                             <input type="text "runat="server" ForeColor="#33CC33" style="font-weight: 700"value="<?php echo  "Tixmate";?>"/>
