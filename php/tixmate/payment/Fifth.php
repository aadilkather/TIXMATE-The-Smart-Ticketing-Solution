...
$sql="select * from account_tbl where userid = '$_SESSION[uid]'";
$res=mysqli_query($con,$sql);
if(mysqli_num_rows($res) > 0 ){
$row = mysqli_fetch_array($res);
$amt = $row['amount'];
$newAmt = $amt + $_SESSION['amt'];

$updateSql = " UPDATE account_tbl SET amount = $newAmt WHERE userid = '$_SESSION[uid]' ";
mysqli_query($con,$updateSql);

$s = " SELECT * FROM account_tbl WHERE userid = '$_SESSION[uid]' ";
...
$cdate = date("d-m-Y");
$tran = "INSERT INTO transaction_tbl(uid, wid, trans_num, amount, tdate, status) VALUES ('$_SESSION[uid]', '$id', $trans_num, '$_SESSION[amt]', '$cdate', 'added') ";
...
$insert = "INSERT INTO account_tbl(userid, account_no, amount, status) VALUES ('$_SESSION[uid]', '$account_no', '$_SESSION[amt]', 'active' ) ";
                    ...
                    <table class="auto-style1">
                        <tr>
                            ...
                            <td class="auto-style32">
                                &nbsp;<input type="text"  runat="server" value="<?php echo "Tixmate";?>"/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style42"></td>
                            <td class="auto-style38">&nbsp; <input type="text" runat="server" value="<?php echo $trans_num; ?> " />
                            </td>
                        </tr>
                        <tr>
