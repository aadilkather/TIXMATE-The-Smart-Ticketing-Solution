    ...
    <table class="auto-style1">
       ...
       <?php
        ...
        <tr>
          ...
          <img alt="" class="auto-style19" src="Images/1391796960_payment_method_card_visa.png" />&nbsp;&nbsp; <input required type="radio" name="rdlcard" id="rdlcard"  runat="server" value="Master Card" 
        ...
        <tr>
          ...
          <input type="text" name="txtamount" readonly id="txtamount" value="<?php echo $_SESSION['amt']; ?>" /></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
            <td>&nbsp;</td>
