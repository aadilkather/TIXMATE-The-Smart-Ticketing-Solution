...
<div class="sidebar" data-color="yh">
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
            <br/> <br/>
               <a href="../dashboard/dashboard.php"><img src="../common/core-img/logo.png" width="200"></a>  
            </div>
    ...
    <div class="main-panel" style=" background-image: url(../dashboard/bg4.jpg);   background-size: cover;">
